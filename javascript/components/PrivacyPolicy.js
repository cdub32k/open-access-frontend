  ...
  return (
    <div className={classes.container}>
      ...
      <Typography variant="body1" style={{ marginBottom: 18 }}>
        ...
        SELLING THAT DATA TO ADVERTISERS. ALL DATA COLLECTED ARE EXPLICITLY
        VISIBLE ON THE SITE. THE SERVER MAY BE ABLE TO DETERMINE A VAGUE
        LOCATION SUCH AS YOUR COUNTRY BASED OFF OF YOU IP ADDRESS, BUT THAT IS
        OF NO INTEREST TO US AND WE DO NOT LOG IT. WHEN YOU DELETE YOUR ACCOUNT,
        ALL ASSOCIATED DATA IS DELETED PERMANENTLY AND CANNOT BE RETRIEVED.
      </Typography>
      ...
      <Typography variant="body1">
        ...
        IS NOT SOMETHING YOU'RE INTERESTED IN THEN ENTER A FAKE ONE. IT WILL NOT
        BE PUBLICLY VISIBLE ANYWAYS
      </Typography>
    </div>
  );
};
